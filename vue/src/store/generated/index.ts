...
import Frank4GInterchangeFrank4GInterchangeDex from './frank4g/interchange/frank4g.interchange.dex'
...
export default { 
  ...
  Frank4GInterchangeFrank4GInterchangeDex: load(Frank4GInterchangeFrank4GInterchangeDex, 'frank4g.interchange.dex'),
