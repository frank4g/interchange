...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/frank4g/interchange/dex/buy_order_book
   */
  queryBuyOrderBookAll = (
    ...
    this.request<DexQueryAllBuyOrderBookResponse, RpcStatus>({
      path: `/frank4g/interchange/dex/buy_order_book`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/frank4g/interchange/dex/buy_order_book/{index}
   */
  queryBuyOrderBook = (index: string, params: RequestParams = {}) =>
    this.request<DexQueryGetBuyOrderBookResponse, RpcStatus>({
      path: `/frank4g/interchange/dex/buy_order_book/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/frank4g/interchange/dex/denom_trace
   */
  queryDenomTraceAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<DexQueryAllDenomTraceResponse, RpcStatus>({
      path: `/frank4g/interchange/dex/denom_trace`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/frank4g/interchange/dex/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<DexQueryParamsResponse, RpcStatus>({
      path: `/frank4g/interchange/dex/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/frank4g/interchange/dex/sell_order_book
   */
  querySellOrderBookAll = (
    ...
    this.request<DexQueryAllSellOrderBookResponse, RpcStatus>({
      path: `/frank4g/interchange/dex/sell_order_book`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/frank4g/interchange/dex/sell_order_book/{index}
   */
  querySellOrderBook = (index: string, params: RequestParams = {}) =>
    this.request<DexQueryGetSellOrderBookResponse, RpcStatus>({
      path: `/frank4g/interchange/dex/sell_order_book/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
